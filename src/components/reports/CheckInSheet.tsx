...
import { formatReportDate, formatReportTimestamp, sortByRunOrder, getOrgTitle } from './reportUtils';
...
export const CheckInSheet: React.FC<CheckInSheetProps> = ({ classInfo, entries, generatedAt }) => {
    ...
    <div className="print-report check-in-sheet">
      ...
      <div className="print-footer">
        ...
        <div className="footer-center">
          <em>This is an unofficial check-in sheet generated by myK9Q</em>
        </div>
