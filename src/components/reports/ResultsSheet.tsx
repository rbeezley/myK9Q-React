...
export const ResultsSheet: React.FC<ResultsSheetProps> = ({ classInfo, entries, generatedAt }) => {
  ...
  return (
    <div className="print-report results-sheet">
      ...
      <div className="print-header">
        ...
        <div className="print-timestamp">Generated: {formatReportTimestamp(timestamp)}</div>
      </div>
      ...
      <div className="print-footer">
        <div className="footer-left">
          <strong>Total Entries:</strong> {sortedEntries.length}
          <span className="qualified-count"><strong>Qualified:</strong> {qualifiedCount}</span>
          <span className="nq-count"><strong>NQ:</strong> {sortedEntries.length - qualifiedCount}</span>
        </div>
        <div className="footer-center">
          <em>These are unofficial preliminary results generated by myK9Q</em>
        </div>
