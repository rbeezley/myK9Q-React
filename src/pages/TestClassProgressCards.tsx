...
import { ClassProgressSummary } from './TVDashboard/components/ClassProgressSummary';
import type { ClassInfo } from './TVDashboard/hooks/useTVData';
...
export const TestClassProgressCards: React.FC = () => {
  return (
    <div style={{
      minHeight: '100vh',
