...
abstract class FlutterFlowTheme {
  ...
  late Color gray600;
  late Color appBar;
  late Color secondaryButtonFill;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF3828E3);
  late Color tertiary = const Color(0xFF39D2C0);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFF4B39EF);
  ...
  late Color primaryBorder = const Color(0xFFFFFFFF);
  late Color lineColor = const Color(0xFFE0E3E7);
  late Color grayIcon = const Color(0xFF95A1AC);
  late Color tertiaryBackground = const Color(0xFFDBE2E7);
  late Color gray600 = const Color(0xFF262D34);
  late Color appBar = const Color(0xFF4B39EF);
  late Color secondaryButtonFill = const Color(0xFF4B39EF);
  late Color colorWhite = const Color(0xFFFFFFFF);
  late Color backgroundComponents = const Color(0xFF4B39EF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBorder = const Color(0xFF1A1F24);
  late Color lineColor = const Color(0xFF22282F);
  late Color grayIcon = const Color(0xFF95A1AC);
  late Color tertiaryBackground = const Color(0x72121212);
  late Color gray600 = const Color(0xFF262D34);
  late Color appBar = const Color(0xFF090F13);
  late Color secondaryButtonFill = const Color(0xFF1E1E1E);
  late Color colorWhite = const Color(0xFFFFFFFF);
  late Color backgroundComponents = const Color(0xFF4B39EF);
  late Color primaryBtnText = const Color(0xFFFFFFFF);
  late Color gray200 = const Color(0xFFDBE2E7);
