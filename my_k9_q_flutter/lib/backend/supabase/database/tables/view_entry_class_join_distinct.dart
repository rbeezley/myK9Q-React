...
class ViewEntryClassJoinDistinctTable
    extends SupabaseTable<ViewEntryClassJoinDistinctRow> {
  @override
  String get tableName => 'view_entry_class_join_distinct';

  @override
  ViewEntryClassJoinDistinctRow createRow(Map<String, dynamic> data) =>
      ViewEntryClassJoinDistinctRow(data);
}

class ViewEntryClassJoinDistinctRow extends SupabaseDataRow {
  ViewEntryClassJoinDistinctRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewEntryClassJoinDistinctTable();
