...
import 'p_scoresheet_a_s_c_a_scent_model.dart';
export 'p_scoresheet_a_s_c_a_scent_model.dart';

class PScoresheetASCAScentWidget extends StatefulWidget {
  const PScoresheetASCAScentWidget({
    super.key,
  ...
  static String routeName = 'p_ScoresheetASCAScent';
  static String routePath = '/ScoresheetASCAScent';

  @override
  State<PScoresheetASCAScentWidget> createState() =>
      _PScoresheetASCAScentWidgetState();
}

class _PScoresheetASCAScentWidgetState
    extends State<PScoresheetASCAScentWidget> {
  late PScoresheetASCAScentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PScoresheetASCAScentModel());
