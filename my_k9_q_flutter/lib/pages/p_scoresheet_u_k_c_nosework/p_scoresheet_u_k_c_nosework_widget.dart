...
import 'p_scoresheet_u_k_c_nosework_model.dart';
export 'p_scoresheet_u_k_c_nosework_model.dart';

class PScoresheetUKCNoseworkWidget extends StatefulWidget {
  const PScoresheetUKCNoseworkWidget({
    super.key,
  ...
  static String routeName = 'p_ScoresheetUKCNosework';
  static String routePath = '/pScoresheetUKCNosework';

  @override
  State<PScoresheetUKCNoseworkWidget> createState() =>
      _PScoresheetUKCNoseworkWidgetState();
}

class _PScoresheetUKCNoseworkWidgetState
    extends State<PScoresheetUKCNoseworkWidget> {
  late PScoresheetUKCNoseworkModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PScoresheetUKCNoseworkModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().asActivePage = 'p_ScoresheetUKCNosework';
      safeSetState(() {});
      _model.pgMaxTimeMS =
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          valueOrDefault<String>(
                                            'Max: ${widget.ppClassRow?.timeLimit}',
                                            '00:01',
                                          ),
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                              ...
                              child: Padding(
                                ...
                                child: FlutterFlowChoiceChips(
                                  options: [
                                    ...
                                    ChipData('False Alert'),
                                    ChipData('Timed Out'),
                                    ChipData('Exposed Hide or Distraction'),
                                    ChipData('Non-Indication'),
                                    ChipData('Too Many Faults')
                                  ],
                                  onChanged: (val) async {
                                    safeSetState(() => _model
                      ...
                      if (_model.choiceChipsUKCValue == 'Qualified')
                        Padding(
                          padding: EdgeInsets.all(8.0),
                          child: Material(
                            color: Colors.transparent,
                                  ...
                                  if (_model.choiceChipsUKCValue ==
                                    ...
                                    if (functions.isStopwatchAreaValid(
                                      ...
                                      FFAppState().asFaultHE =
                                          _model.countControllerFaultHEValue!;
                                      FFAppState().asArea1Error = false;
                                      safeSetState(() {});
                                    } else {
