...
import 'c_confirm_score_a_k_c_scent_work_model.dart';
export 'c_confirm_score_a_k_c_scent_work_model.dart';

class CConfirmScoreAKCScentWorkWidget extends StatefulWidget {
  const CConfirmScoreAKCScentWorkWidget({
    super.key,
  ...
  @override
  State<CConfirmScoreAKCScentWorkWidget> createState() =>
      _CConfirmScoreAKCScentWorkWidgetState();
}

class _CConfirmScoreAKCScentWorkWidgetState
    extends State<CConfirmScoreAKCScentWorkWidget>
    with TickerProviderStateMixin {
  late CConfirmScoreAKCScentWorkModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CConfirmScoreAKCScentWorkModel());
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          if ((widget.cpFaults > 0) &&
                              (widget.cpResult == 'Qualified'))
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  8.0, 0.0, 0.0, 0.0),
                              child: Text(
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          if (widget.cpArea3 != '00:00.00')
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  4.0, 0.0, 4.0, 0.0),
                              child: Text(
                                'Area 3 -  ${valueOrDefault<String>(
                                  widget.cpArea3,
                                  '00:00.00',
                                )}',
                                textAlign: TextAlign.center,
