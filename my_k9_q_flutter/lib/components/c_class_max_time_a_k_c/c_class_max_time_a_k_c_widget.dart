...
import 'c_class_max_time_a_k_c_model.dart';
export 'c_class_max_time_a_k_c_model.dart';

class CClassMaxTimeAKCWidget extends StatefulWidget {
  const CClassMaxTimeAKCWidget({
    super.key,
  ...
  @override
  State<CClassMaxTimeAKCWidget> createState() => _CClassMaxTimeAKCWidgetState();
}

class _CClassMaxTimeAKCWidgetState extends State<CClassMaxTimeAKCWidget>
    with TickerProviderStateMixin {
  late CClassMaxTimeAKCModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CClassMaxTimeAKCModel());
