...
import 'c_check_in_entry_list_tabs_with_section_model.dart';
export 'c_check_in_entry_list_tabs_with_section_model.dart';

class CCheckInEntryListTabsWithSectionWidget extends StatefulWidget {
  const CCheckInEntryListTabsWithSectionWidget({
    super.key,
  ...
  @override
  State<CCheckInEntryListTabsWithSectionWidget> createState() =>
      _CCheckInEntryListTabsWithSectionWidgetState();
}

class _CCheckInEntryListTabsWithSectionWidgetState
    extends State<CCheckInEntryListTabsWithSectionWidget>
    with TickerProviderStateMixin {
  late CCheckInEntryListTabsWithSectionModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => CCheckInEntryListTabsWithSectionModel());
